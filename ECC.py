...
def main():
    # p1,p2 is two point on ECC , p,q,n is the ecc parameters y^2=x^3+px+q(mod n)
    n = 115792089210356248762697446949407573530086143415290314195533631308867097853951
    p = 115792089210356248762697446949407573530086143415290314195533631308867097853948
    q = 41058363725152142129326129780047268409114441015993725554835256314039467401291
    p1 = 80278763193120003587387352933530095709762981486450239069372826084146933879933, 112497380992627717765326349342009060812349232694190295493353543929330711400321
    p2 = 9, 7
    c = 5
    d=mul(p, q, n, p1, c)
    print(d)
    #38388489199885501903337662134935379732040100673985257427995291621296671533467, 77141506481432796157946738610939364863206531145303026958183630063305955246665
    # Curve'prime256v1' = > y ^ 2 = x ^ 3 + a * x + b(modp):
