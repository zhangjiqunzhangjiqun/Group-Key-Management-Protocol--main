...
def main():
    print(int("fffffffffffffffffffffffffffffffeffffffffffffffff", base=16))
    print(int("ffffffffffffffffffffffff99def836146bc9b1b4d22831", base=16))
    print(int("64210519e59c80e70fa7e9ab72243049feb8deecc146b9b1", base=16))
    print(int("188da80eb03090f67cbf20eb43a18800f4ff0afd82ff1012", base=16))
    print(int("07192b95ffc8da78631011ed6b24cdd573f977a11e794811", base=16))
    p = int("fffffffffffffffffffffffffffffffeffffffffffffffff", base=16)
    q = int("fffffffffffffffffffffffffffffffeffffffffffffffff", base=16) - int(
        "64210519e59c80e70fa7e9ab72243049feb8deecc146b9b1", base=16)
    n = int("ffffffffffffffffffffffff99def836146bc9b1b4d22831", base=16)
    p1 = 3, 10
    p2 = 9, 7
    p3 = int("188da80eb03090f67cbf20eb43a18800f4ff0afd82ff1012", base=16), int(
        "07192b95ffc8da78631011ed6b24cdd573f977a11e794811", base=16)
    c = int("ffffffffffffffffffffffff99def836146bc9b1b4d22831", base=16)
    sum_add = 0
    sum_mul = 0
    i = 1
    for i in range(1000):
        ...
        sum_add = sum_add + t2 - t1
        t3 = time.perf_counter()
        mul(p, q, n, p3, c)
        t4 = time.perf_counter()
        sum_mul = sum_mul + t4 - t3
    print("Total time of 1000 times add on ECC:", sum_add)
    print("Average_time of add operation on ECC:", sum_add / 1000)
    print("Total time of 1000 times scalar multiplication operation on ECC:", sum_mul)
    print("Average_time of scalar multiplication operation on ECC:", sum_mul / 1000)
